...
- `raw_data/` – CSV snapshots for locations, orders and financial metrics
- `trigger_logs/` – grant or investor trigger data
- `quant_search/` – reference JSON files from funding program searches
